 ...
 * @author Ramiz
 */
public class MaterialView extends javax.swing.JDialog {
    ...
    int table_counter=0;  
    DB db=new DB();
    public MaterialView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         loadInTable();
    }
...
//            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaterialView dialog = new MaterialView(new javax.swing.JFrame(), true);
