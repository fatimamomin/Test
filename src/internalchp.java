...
public class internalchp extends javax.swing.JInternalFrame {

    /**
     * Creates new form internalchp
     */
    public internalchp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("ChangePassword"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {   ConItem cn1=new ConItem();
            ...
            cn1.stmt=cn1.con.prepareStatement("update login set username=?,password=? where username='"+s+"'");
            //cn1.stmt.setInt(1, Integer.parseInt(t1.getText()));
            cn1.stmt.setString(1,jTextField4.getText());
