 ...
 * @author Ramiz
 */
public class finalStaff extends javax.swing.JFrame {

    /**
     * Creates new form finalStaff
     */
       String name = null;
    String address  = null;
    String phone1 = null;
...
//     dt2.setDateFormatString("yyyy-MM-dd");
    ...
    private void initComponents() {
        ...
        dt2.setDateFormatString("yyyy mm d");
     ...
     void update()
    {
        ...
        {   ConItem cn1=new ConItem();
            ...
            //int ino=Integer.parseInt(st1.getText());
              ...
              String nm=st2.getText();
         cn1.stmt=cn1.con.prepareStatement("update staff set name=?,address=?,phone_1=?,phone_2=?,designation=?,dob=?,doj=? where name='"+nm+"'");
          ...
          cn1.stmt.setString(1,st2.getText());
             ...
             cn1.stmt.setInt(3, Integer.parseInt(st4.getText()));
              cn1.stmt.setInt(4, Integer.parseInt(st5.getText()));
               cn1.stmt.setString(5,st6.getText());
 //                  java.util.Date dateFromDateChooser1 = dt1.getDate();
//String dateString = String.format("%1$td-%1$tm-%1$tY", dateFromDateChooser1); 
              // cn1.stmt.setString(2, dateString);
 //java.util.Date dateFromDateChooser1 = dt1.getDate();
 String dt=dt1.getDate()+"";
                     //cn1.stmt.setDate(6,dt1.getDate());
                     cn1.stmt.setString(6,dt);
                      //String dateValue = (cn1.rs.getString("dob")) ;//What ever column/
//java.util.Date date = new SimpleDateFormat("dd-MM-yyyy").parse(dateValue);


String date1=dt2.getDate()+"";
                     cn1.stmt.setString(7,date1);
   ...
   // String pf = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(finalStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new finalStaff().setVisible(true);
            }
        });
    }
